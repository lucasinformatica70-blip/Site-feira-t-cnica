...
<head>
    ...
    <script src="./javascript/scriptguia.js" defer></script>
</head>
...
<div class="slideshow">
    ...
    <section class="slide split-slide slide-3">
    <div class="split-image">
    ...
    <div class="split-text">
        ...
        <p>Os centros de distribuição da Amazon são instalações modernas e seguras com processos altamente automatizados de coleta, embalagem e envio para facilitar o processamento seguro e pontual de inventário e pedidos de clientes.
...
Centros de distribuição da Amazon</p>
    ...
    <button id="nextButton" class="button is-primary is-light next-button">
      >
    </button>
