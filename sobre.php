...
<body>
<p>O Processo Criativo foi dado a partir de que, oque tinha que ser feito era que o trabalho é um site feito em php, língua de programação comum em desenvolvimento web, o site mostra como a tecnologia da informação é aplicada na logística e tem uma barra de navegação com "home" "sobre nós" "serviços" e "contato", a ideia foi dada pelo professor  nosso Jesus Germano que sugeriu pra gente ideias e dentre elas o trabalho ser sobre a explicação de um dos trabalhos da nossa sala, e o escolhido é o que estamos trabalhando sobre que é o Centro De Distribuição da Amazon, que escolhemos por que gostamos do tema e que era um trabalho desenvolvido bem, e automatizado de uma forma bem dinâmica, esse tema nada mais é que: Os centros de distribuição da Amazon são instalações modernas e seguras com processos altamente automatizados de coleta, embalagem e envio para facilitar o processamento seguro e pontual de inventário e pedidos de clientes.
