...
<p class="is-centered">O Processo Criativo foi dado a partir de que, oque tinha que ser feito era que o trabalho é um site feito em php, língua de programação comum em desenvolvimento web, o site
mostra como a tecnologia da informação é aplicada na logística e tem uma barra de navegação com "home" "sobre nós" "serviços" e "contato", a ideia foi dada pelo professor
nosso Jesus Germano que sugeriu pra gente ideias e dentre elas o trabalho ser sobre a explicação de um dos trabalhos da nossa sala, e o escolhido é o que estamos trabalhando sobre o que é o Centro De Distribuição da Amazon, que escolhemos por que gostamos do tema e que era um trabalho desenvolvido bem, e automatizado de uma forma bem dinâmica, esse tema nada mais é que: Os centros de distribuição da Amazon são instalações modernas e seguras com processos altamente automatizados de coleta, embalagem e envio para facilitar o processamento seguro e pontual de inventário e pedidos de clientes.
Fiz uma pesquisa sobre o tema e está muito bem explicado nesse trecho aqui acima.
O trabalho foi sendo feito, o Código foi sendo feito para ser formado o nosso site, e ele foi feito com a ajuda de uma ferramenta de estilização também sugerida pelo nosso professor que foi o: O site tem estilização em css com a ajuda da ferramenta bulma.io, e o Wireframe que nada mais é que o desenho sobre a estrutura do site, ou seja, como iria ficar ele de forma completa, E o nosso trabalho tem javascript para a segunda página (código pego de exemplos da Internet).
Dessa forma o trabalho foi sendo bem estruturado, e de forma que também foi tomando peso, e de uma forma com quem a gente também pudesse mostrar o crescimento do nosso entendimento, e do nosso aprendizado com o nosso curso técnico que ensino muito sobre informática básica e as suas vertentes sobre ela, e sobre muito mais....
E essa foi uma explicação básica mais de uma forma mais auto explicativa para dar uma entendida a mais no tema e saber explicar de uma forma e um jeito mais aptas para o público sobre o nosso tema.</p>
</section>
...
<footer class="footer has-background-black-bis">
  <div class="content has-text-centered has-text-grey">
    <p>
      2026 Todos os direitos reservados - Lucas Vieira de Freitas, Davi Freire da Cunha Reggiani, Matheus Ferreira Valadares Cruz<br>
